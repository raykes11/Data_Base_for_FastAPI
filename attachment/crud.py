...
from attachment.schemas import AttachmentCreate, AttachmentUpdate, AttachmentUpdatePartial
...
async def create_attachment(session: AsyncSession, attachment_in: AttachmentCreate) -> Attachment:
...
async def update_attachment(session:AsyncSession, attachment: Attachment, attachment_update: AttachmentUpdate | AttachmentUpdatePartial, partial: bool = False) -> Attachment:
